...
*/
?>
<section class="discover-long-author full-author-panel rui-clearfix">

<?php if(isset($authorAvatar)) {
    echo '<img src="' . $authorAvatar[0] . '" width="' . $authorAvatar[1] . '" height="' . $authorAvatar[2] . '" alt="' . $authorName . '" class="author-avatar"/>';
}
?>

<div class="author-details">
    <div class="posted-by">About</div>
    <div itemprop="author" class="author-name"><?php echo $authorName ?></div>
